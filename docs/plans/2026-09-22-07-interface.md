...
- [ ] **Étape 3 : la barre, la garde, le catalogue**
...
- [ ] **Étape 4 : les deux pages publiques**
...
- [ ] **Étape 5 : lancer les tests, le typage et la construction**

Run: `cd web && npx vitest run && npm run typecheck && npm run build`
Attendu : tous PASS.

- [ ] **Étape 6 : vérifier par mutation**
