...
Run : `uv run pytest tests/test_nodes.py tests/test_graph.py -v`, puis la suite entière.
...
```bash
git add backend/app/agent/nodes.py backend/tests/test_nodes.py backend/tests/test_graph.py
